...
namespace Teelol{
  ...
  struct my_proto: public protocol<>{
    ...
    message <10, void(string, int,int)>           addBullet;     //serveur envoi une bullet au client
    ...
    message <16, void(string, int,int)>           bulletMoved;   //serveur envoi le deplacement d'un bullet
    ...
    message <25, void(string)>                    explode;     //serveur envoi l'explosion d'un bullet
    ...
    my_proto(socket &io): protocol<>(io), move(this), moveOk(this),
			  ...
			  bulletMoved(this), hurt(this), hurted(this), 
